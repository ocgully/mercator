...
from codeatlas import __version__ as _version, SCHEMA_VERSION as _schema
from codeatlas import paths as _paths
from codeatlas import boundaries as _boundaries_mod
from codeatlas import projects as _projects_mod
from codeatlas import repo_edges as _repo_edges_mod
from codeatlas import coverage as _coverage_mod
from codeatlas.render import atlas as _atlas_html
...
def write_atlas(repo_root: Path) -> Path:
    ...
    if coverage_doc is None:
        try:
            ...
            coverage_doc = None
    from codeatlas import repo_boundaries as _repo_bnd_mod
    try:
