...
Severity tiers:
  ...
  warning  — worth reviewing; does not fail `codeatlas check`
  error    — fails `codeatlas check` (exit 1); CI-blocking
...
# ---------------------------------------------------------------------------
# Scaffold template for `codeatlas boundaries init`
# ---------------------------------------------------------------------------

SCAFFOLD_JSON = """{
  "schema_version": "1",

  "_doc": "Edit this file to declare forbidden system-to-system edges (DMZs). Run `codeatlas check` after editing to see violations. Delete this _doc field when done.",
